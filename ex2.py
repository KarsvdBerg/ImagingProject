# -*- coding: utf-8 -*-
"""
Created on Wed Feb 13 16:37:17 2019
...
model.add(Dense(64, activation='relu')) #1
model.add(Dense(64, activation='relu')) #2
model.add(Dense(64, activation='relu')) #3
model.add(Dense(64, activation='relu')) #4
model.add(Dense(64, activation='relu')) #5
model.add(Dense(64, activation='relu')) #6
model.add(Dense(64, activation='relu')) #7
model.add(Dense(64, activation='relu')) #8
model.add(Dense(64, activation='relu')) #9
model.add(Dense(64, activation='relu')) #10
